...
namespace BIMA.Database.Migrations
{
    ...
    [Migration("20210328193420_updateCourseCategoryTableWithNullableParentCategoryId")]
    partial class updateCourseCategoryTableWithNullableParentCategoryId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BIMA.Database.Entities.Course", b =>
                {
                    b.HasOne("BIMA.Database.Entities.CourseCategory", null)
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("BIMA.Database.Entities.CourseCategory", b =>
                {
                    b.HasOne("BIMA.Database.Entities.Course", "Course")
                        .WithOne("CourseCategory")
                        .HasForeignKey("BIMA.Database.Entities.CourseCategory", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("BIMA.Database.Entities.UserCourseContent", b =>
                {
                    b.HasOne("BIMA.Database.Entities.CourseContent", "CourseContent")
